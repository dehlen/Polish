...
public final class GenericCollectionViewController<V: UIView, C: ContainerCollectionViewCell<V>>: UICollectionViewController {
    ...
    public init(viewType: V.Type, layout: UICollectionViewLayout? = nil) {
    ...
    public override func viewDidLoad() {
        ...
        collectionView?.register(C.self, forCellWithReuseIdentifier: "CollectionViewCell")
    }
    ...
    public override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "CollectionViewCell", for: indexPath) as? C else {
